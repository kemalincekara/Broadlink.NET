...
namespace Broadlink.NET
{
    public static class PacketGenerator
    {
        ...
        public static byte[] GenerateCommandPacket(short commandCode, byte[] payload, BroadlinkDevice device)
        {
        ...
        public static byte[] GenerateCheckRFDataFirstPacket(BroadlinkDevice device)
        {
            var payload = new byte[16];
            payload[0x00] = 0x1a;
        ...
        public static byte[] GenerateCheckRFDataSecondPacket(BroadlinkDevice device)
        {
            var payload = new byte[16];
            payload[0x00] = 0x1b;
